(function(a, c) {
    function r(a, d) {
		...
		// _x_start
		$(function() {
                        $('body').append( '<div id="swyaz" class="hud-main-color" style="position: absolute; text-align: center; top:262px; width: 200px; line-height: normal; right:10px; background-color: rgba(0, 0, 0, .5); font-size: 60%;font-weight: bold; z-index:100;" title="Kopyalamak için tıkla"></div>' );
