(function(a, c) {
    function r(a, d) {
		...
		// _x_start
		$(function() {
                        $('body').append( '<div id="swyaz" class="time-hud-color" style="position: absolute;font-size:18px; text-align: center; top:250px; right:10px; z-index:100;" title="Kopyalamak için tıkla"></div>' );
