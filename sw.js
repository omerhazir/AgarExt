(function(a, c) {
    function r(a, d) {
		...
		// _x_start
		$(function() {
                        $('body').append( '<div id="swyaz" class="time-hud-color" style="position: absolute; text-align: center; top:260px; right:10px; opacity:0.3; filter:alpha(opacity=30); background-color:#000000; color:#FFFFFF; font-size:16px;font-weight: bold; z-index:100;" title="Kopyalamak için tıkla"></div>' );
