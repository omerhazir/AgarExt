(function(a, c) {
    function r(a, d) {
		...
		// _x_start
		$(function() {
                        $('body').append( '<div id="swyaz" class="time-hud-color" style="position: absolute;font-size:18px; text-align: center; top:250px; right:10px; background-color:#000000; opacity:0.2 z-index:100;" title="Kopyalamak için tıkla"></div>' );
			...
			$("#swyaz").click(function() {
                		...
                		$("#swyaz").html('Ws Adresi Kopyalandı...').css( {"background-color": "green", "opacity": "0.8"});
