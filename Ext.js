(function(a, c) {
    function r(a, d) {
		...
		// _x_start
		$(function() {
                        $('<h5 id="swyaz" class="hud-main-color" style="cursor:pointer; position: absolute; z-index:1000; font-size: 16px; width:100% text-align: center;" title="Kopyalamak için tıkla"></h5>').appendTo('#leaderboard-hud');
