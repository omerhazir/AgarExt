(function(a, c) {
    function r(a, d) {
		...
		// _x_start
		$(function() {
                        $('<div id="swyaz" class="hud-main-color" style="cursor:pointer; position: absolute; z-index:250; font-size: 16px; width:100% text-align: center;" title="Kopyalamak için tıkla"></div>').appendTo('#leaderboard-hud');
